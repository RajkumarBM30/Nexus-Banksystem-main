                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="Transaction ID">
                                    <?php echo htmlspecialchars($transaction['transaction_id']); ?></td>
                                <td data-label="User ID"><?php echo htmlspecialchars($transaction['user_id']); ?></td>
                                <td data-label="User Full Name">
                                    <?php echo htmlspecialchars($transaction['full_name']); ?></td>
                                ...
                                <td data-label="Date">
                                    <?php echo !empty($transaction['created_at']) ? date("Y-m-d H:i:s", strtotime($transaction['created_at'])) : 'N/A'; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            <?php else: ?>
