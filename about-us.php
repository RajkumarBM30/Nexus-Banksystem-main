...
<head>
    ...
    * {
    ...
    @media (max-width: 768px) {
        ...
        .auth-buttons {
            top: calc(60px + 250px);
            /* Adjust based on nav-links height */
    ...
    .page-title {
        ...
        text-align: center;
        background:
            linear-gradient(rgba(0, 30, 60, 0.6),
                rgba(0, 30, 60, 0.6)),
...
<body>
    ...
    <section class="about-content">
        <div class="container">
            ...
            <p>
                We believe in building lasting relationships with our clients based on transparency, integrity, and
                mutual success.
                Whether you're saving for the future, investing, or managing daily finances, Nexus Bank is here to guide
                you every step of the way.
            </p>
            <h2>Our Vision</h2>
            <p>
                To be the most trusted and customer-centric bank recognized for excellence in financial services and
                community support.
            </p>
            <h2>Our Values</h2>
            <ul>
