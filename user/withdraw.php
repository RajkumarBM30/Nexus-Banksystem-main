        ...
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="withdraw.php" class="btn dash-text">
                    <img src="../assets/images/hover-withdraw.png" alt="withdraw-logo" class="nav-icon"
            ...
            <div class="wrap">
                ...
                <div class="Summary">
                    <div style="width: 100%;">
                        <h2>Quick Summary</h2>
                        <ul>
                            <li>Total Withdrawals This Month: <strong>₹<?= number_format($monthlyTotal, 2) ?></strong>
                            </li>
                            <li>Largest Withdraw: <strong>₹<?= number_format($largestDeposit, 2) ?></strong></li>
                            <li>Average Weekly withdrawal:
                                <strong>₹<?= number_format($averageWeeklyDeposit, 2) ?></strong>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <table class="transactions-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button
                                    onclick="window.open('generate_receipt.php?transaction_id=<?= htmlspecialchars($txn['transaction_id']) ?>', '_blank')"
