        ...
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="transactions.php" class="btn dash-text">
                    <img src="../assets/images/hover-transaction.png" alt="transactions-logo" class="nav-icon"
                    ...
                    <div class="search-filter-container">
                        <form method="GET" class="search-filter-form">
                            <div class="search-box">
                                <input type="text" name="search" placeholder="Search by description or transaction ID"
                            ...
                            <div class="filter-box">
                                <select name="type">
                                    ...
                                    <option value="deposit"
                                        <?= ($_GET['type'] ?? '') === 'deposit' ? 'selected' : '' ?>>Deposit</option>
                                    <option value="withdrawal"
                                        <?= ($_GET['type'] ?? '') === 'withdrawal' ? 'selected' : '' ?>>Withdraw
                                    </option>
                                    <option value="withdrawal_matured_investment"
                                        <?= ($_GET['type'] ?? '') === 'withdrawal_matured_investment' ? 'selected' : '' ?>>
                                        Withdrawal Matured Investment</option>
                                    <option value="investment"
                                        <?= ($_GET['type'] ?? '') === 'investment' ? 'selected' : '' ?>>Investment
                                    </option>
                                    <option value="approved_loan"
                                        <?= ($_GET['type'] ?? '') === 'approved_loan' ? 'selected' : '' ?>>Approved Loan
                                    </option>
                                    <option value="transfer_in"
                                        <?= ($_GET['type'] ?? '') === 'transfer_in' ? 'selected' : '' ?>>Transfer In
                                    </option>
                                    <option value="transfer_out"
                                        <?= ($_GET['type'] ?? '') === 'transfer_out' ? 'selected' : '' ?>>Transfer Out
                                    </option>
                                </select>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="icon" style="width: 32px; text-align: center;">
                                        ...
                                        <img src="../assets/images/Trans-up.png" alt="arrow Up"
                                            style="width: 30px; height: 30px; display: inline-block;">
                                        <?php else: ?>
                                        <img src="../assets/images/Trans-down.png" alt="arrow down"
                                            style="width: 30px; height: 30px; display: inline-block;">
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td
                                        class="amount <?= in_array($txn['type'],['deposit','transfer_in', 'approved_loan', 'withdrawal_matured_investment'])? 'positive':'negative' ?>">
                                    ...
                                    <td>
                                        <a href="generate_receipt.php?transaction_id=<?= urlencode($txn['transaction_id']) ?>"
                                            class="btn-download"
