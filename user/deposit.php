                ...
                <div class="Summary">
                    <div style="width: 100%;">
                        ...
                        <ul>
                            ...
                            <li>Average Weekly Deposit: <strong>₹<?= number_format($averageWeeklyDeposit, 2) ?></strong>
                            </li>
                            <li>Deposited this week: <strong>₹<?= number_format($weeklyDeposits, 2) ?></strong> /
                                ₹100,000 limit</li>
                        </ul>
                    </div>
                </div>
